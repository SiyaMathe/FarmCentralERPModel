<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeLogin.aspx.cs" Inherits="ABCSAMPLE.EmployeeLogin" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            <asp:Label ID="lblLoginStatus" runat="server" Text="Idle"></asp:Label>
        </p>
